...
option_list = list(
    ...
    optparse::make_option(c("-p", "--path"), action="store", default=Sys.getenv("FLEPI_PATH", "COVIDScenarioPipeline"), type='character', help="path to the COVIDScenarioPipeline directory"),
