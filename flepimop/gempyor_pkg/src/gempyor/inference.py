...
class TestECMCE:
    def __init__(self, nwalkers, niter, nsamples, nthin, run_id, modinf, inferpar, loss, static_sim_arguments):
        ...
        self.run_id = run_id
        self.modinf = modinf
        self.inferpar = inferpar
        self.loss = loss
        self.static_sim_arguments = static_sim_arguments

    def run(self, p):
        a = emcee_logprob(p, self.modinf, self.inferpar, self.loss, self.static_sim_arguments)
        print("llik:", a)
        return a
