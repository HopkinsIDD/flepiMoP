...
class ModelMeta(BaseModel):
    ...
    Examples:
        ...
        >>> meta = ModelMeta(name="simple-model", write_csv=True)
        >>> meta.setup_name
        'simple-model'
        >>> meta.in_run_id
        '20250619_103909'
        ...
        '20250619_103909'
        >>> meta.in_prefix
        'simple-model/20250619_103909/'
        >>> meta.out_prefix
        'simple-model/20250619_103909/'
        >>> meta.filename("spar", 42, "out").relative_to(Path.cwd())
        PosixPath('model_output/simple-model/20250619_103909/spar/000000042.20250619_103909.spar.csv')
