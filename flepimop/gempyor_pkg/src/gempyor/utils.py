...
def get_truncated_normal(
    ...
    Examples:
        Create a truncated normal distribution with specified parameters
        (truncated between 1 and 10):

        >>> get_truncated_normal(mean=5, sd=2, a=1, b=10) # doctest: +ELLIPSIS
...
def get_log_normal(
    ...
    Examples:
        ...
        >>> get_log_normal(meanlog=1, sdlog=0.5)  # doctest: +ELLIPSIS
        <scipy.stats._distn_infrastructure.rv_continuous_frozen object at ...>
...
def as_random_distribution(self):
    ...
    Examples:
        >>> import confuse
        >>> import gempyor
        >>> config_truncnorm = confuse.RootView([confuse.ConfigSource.of({
        ...
        >>> truncnorm_dist_function() # doctest: +SKIP
        0.312745
