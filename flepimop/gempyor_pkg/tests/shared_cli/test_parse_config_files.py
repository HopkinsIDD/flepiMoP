...
other_single_opt_args = [
    "write_csv", "write_parquet", "first_sim_index", "jobs", "nslots", "stoch_traj_flag",
    "in_run_id", "out_run_id", "in_prefix"
]
...
def bad_opt_args(opt : str) -> dict[str, Any]:
    return { opt: {
        ...
        "seir_modifiers_scenario": 1, "outcome_modifiers_scenario": 1,
        "jobs": -1, "nslots": -1, "stoch_traj_flag": "foo", "in_run_id": -1, "out_run_id": -1,
        "in_prefix": [42],
    }[opt] }
...
def good_opt_args(opt : str) -> dict[str, Any]:
    return { opt: {
        ...
        "seir_modifiers_scenario": "example", "outcome_modifiers_scenario": "example",
...
def ref_cfg_kvs(opt : str) -> dict[str, Any]:
    return { opt: {
        ...
        "seir_modifiers_scenario": ["example", "ibid"], "outcome_modifiers_scenario": ["example", "ibid"],
