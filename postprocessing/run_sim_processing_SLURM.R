...
option_list = list(
  ...
  optparse::make_option(c("-g","--pull-gt"), action="store", dest = "pull_gt", default=Sys.getenv("PULL_GT",FALSE), type='logical', help = "Pull ground truth"),
  optparse::make_option(c("-n","--run-diagnostics"), action="store", dest = "run_diagnostics", default=Sys.getenv("DIAGNOSTICS",TRUE), type='logical', help = "Run diagnostics"),
